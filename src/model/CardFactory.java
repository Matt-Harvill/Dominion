...
public class CardFactory {
    ...
    public static Card getCard(String cardType) {
        switch (cardType) {
            ...
            case "Village": return new ActionCardIndependent(cardType, 3, "+1 Card +2 Actions", new Image(new File("Images/Village.jpg").toURI().toString()));
            case "Woodcutter": return new ActionCardIndependent(cardType, 3, "+1 Buy +2 Coins", new Image(new File("Images/Woodcutter.jpg").toURI().toString()));
            case "Smithy": return new ActionCardIndependent(cardType, 4, "+3 Cards", new Image(new File("Images/Smithy.jpg").toURI().toString()));
            case "Festival": return new ActionCardIndependent(cardType, 5, "+2 Actions +1 Buy +2 Coins", new Image(new File("Images/Festival.jpg").toURI().toString()));
            case "Laboratory": return new ActionCardIndependent(cardType, 5, "+2 Cards +1 Action", new Image(new File("Images/Laboratory.jpg").toURI().toString()));
            case "Market": return new ActionCardIndependent(cardType, 5, "+1 Card +1 Action +1 Buy +1 Coin", new Image(new File("Images/Market.jpg").toURI().toString()));
